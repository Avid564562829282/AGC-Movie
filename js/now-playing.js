...
async function loadMovies() {
    ...
    let endpoint;
    if (window.location.pathname.includes('now-playing')) {
        endpoint = 'now_playing';
        document.title = 'AGC Movie - Now Playing';
    } else if (window.location.pathname.includes('popular')) {
        endpoint = 'popular';
        document.title = 'AGC Movie - Popular';
    } else if (window.location.pathname.includes('upcoming')) {
        endpoint = 'upcoming';
        document.title = 'AGC Movie - Upcoming';
    } else if (window.location.pathname.includes('top-rated')) {
        endpoint = 'top_rated';
        document.title = 'AGC Movie - Top Rated';
    }
